...
const CODE_MAP map_rsl366_cmd[] = {
	{ "off", 4 },
	{ "on",  0 },
	{ }
};

const CODE_MAP map_screen_cmd[] = {
	{ "up",   2 },
	{ "down", 4 },
	{ "stop", 8 },
	{ }
...
const CODE_MAP map_rsl2_button[] = {
	{ "1", 0b10 },
	{ "2", 0b01 },
	{ "3", 0b11 },
	{ "4", 0b00 },
...
const CODE_FRAME frames_it[] = {
	{ 0, 0b0001 },
	{ 1, 0b0100 },
};

const CODE_FRAME frames_it_dim[] = {
	{ 0, 0b0000 },
};

const CODE_FRAMEDEF framedef_it[] = {
	{ 1, 4, array(frames_it) }
};

const CODE_FRAMEDEF framedef_it_dim[] = { 
	{ 1, 4, array(frames_it),     28 },
	{ 1, 4, array(frames_it_dim), 27 },
	{ 1, 4, array(frames_it) ,    0  },
};

const CODE_FRAME frames_rsl366[] = {
	{ 0, 0x6666, },
	{ 1, 0x5666, },
	{ 2, 0x6566, },
	{ 3, 0x6656, },
...
const CODE_FRAMEDEF framedef_rsl366[] = {
	{ 4, 16, array(frames_rsl366) }
};

const CODE_FRAME frames_2bit[] = {
	{ 0, 0b01, },
	{ 1, 0b10, },
};

const CODE_FRAMEDEF framedef_2bit[] = {
	{ 1, 2, array(frames_2bit) }
};

const CODEDEF rf433_codes[] = {
	{
